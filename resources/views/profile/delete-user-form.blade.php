...
.') }}
    ...
    <x-slot name="content">
        ...
        <div class="">
            <x-danger-button wire:click="confirmUserDeletion" wire:loading.attr="disabled" style="background-color: red; border-radius:10px 10px">
               <i class="fa fa-trash"></i> {{ __('Supprimer le compte') }}
            </x-danger-button>
        </div>
