            ...
            <div class="row g-0">
                        ...
                        <div class="card-body emails-list-header p-3 py-2">
                            ...
                            <div class="d-flex justify-content-between align-items-center ps-1">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="btn btn-icon btn-text-secondary rounded-pill me-1">
                                        <i
                                            class="icon-base ri ri-mail-open-line icon-22px email-list-read cursor-pointer"></i>
                                    </div>
                                    <div class="dropdown me-1">
                                        <button class="btn btn-icon btn-text-secondary rounded-pill p-0" type="button"
                                            id="dropdownMenuFolderOne" data-bs-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">
                            ...
                            <ul class="list-unstyled m-0">
                                <li class="email-list-item email-marked-read d-flex align-items-center"
                                    ...
                                    <div class="d-flex align-items-center w-100">
                                        ...
                                        <img src="{{ asset('assets_2/img/avatars/1.png')}}" alt="user-avatar"
                                            class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32"
                                            width="32" />
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 text-heading">Chandler
                                                Bing</span>
                                        ...
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            ...
                                            <small class="email-list-item-time text-body-secondary">08:40
                                                AM</small>
                                ...
                                <li class="email-list-item email-marked-read d-flex align-items-center" data-sent="true"
                                    ...
                                    <div class="d-flex align-items-center w-100">
                                        ...
                                        <span class="ms-sm-2 me-3 d-sm-inline-block d-none"><i
                                                class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                        <img src="{{ asset('assets_2/img/avatars/2.png')}}" alt="user-avatar"
                                            class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32"
                                            width="32" />
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Ross
                                                Geller</span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                                Hey Katy, Dessert soufflé tootsie roll soufflé carrot
                                                cake halvah jelly.</small>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                            ...
                                            <span
                                                class="email-list-item-label badge badge-dot bg-danger d-none d-md-inline-block me-2"
                                                data-label="private"></span>
                                            <small class="email-list-item-time text-body-secondary">10:12
                                                AM</small>
                                            <ul class="list-inline email-list-item-actions">
                                                <li
                                                    class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill">
                                ...
                                <li class="email-list-item email-marked-read d-flex align-items-center" data-draft="true"
                                    ...
                                    <div class="d-flex align-items-center w-100">
                                        ...
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Barney
                                                Stinson</span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                        ...
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            ...
                                            <small class="email-list-item-time text-body-secondary">12:44
                                                AM</small>
                                            <ul class="list-inline email-list-item-actions">
                                                <li
                                                    class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill">
                                ...
                                <li class="email-list-item d-flex align-items-center" data-starred="true"
                                    data-bs-toggle="sidebar" data-target="#app-email-view">
                                    <div class="d-flex align-items-center w-100">
                                        <div class="form-check mb-0 ms-2 mt-1">
                                            <input class="email-list-item-input form-check-input" type="checkbox"
                                        ...
                                        <span class="ms-sm-2 me-3 d-sm-inline-block d-none"><i
                                                class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                        <img src="{{ asset('assets_2/img/avatars/3.png')}}" alt="user-avatar"
                                            class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32"
                                            width="32" />
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Pheobe
                                                Buffay</span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                                Hey Katy, Tart croissant jujubes gummies macaroon Icing
                                                sweet.</small>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                ...
                                <li class="email-list-item email-marked-read d-flex align-items-center" data-spam="true"
                                    ...
                                    <div class="d-flex align-items-center w-100">
                                        ...
                                        <span class="ms-sm-2 me-3 d-sm-inline-block d-none"><i
                                                class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                        <img src="{{ asset('assets_2/img/avatars/4.png')}}" alt="user-avatar"
                                            class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32"
                                            width="32" />
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Ted
                                                Mosby</span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                                Hey Katy, I love Pudding cookie chocolate sweet tiramisu
                                                jujubes I love danish.</small>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                ...
                                <li class="email-list-item d-flex align-items-center" data-trash="true"
                                    data-bs-toggle="sidebar" data-target="#app-email-view">
                                    <div class="d-flex align-items-center w-100">
                                        <div class="form-check mb-0 ms-2 mt-1">
                                            <input class="email-list-item-input form-check-input" type="checkbox"
                                        ...
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Stacy
                                                Cooper</span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                                Hey Katy, I love danish. Cupcake I love carrot cake
                                                sugar plum I love.</small>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                                class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                                                data-label="work"></span>
                                            <small class="email-list-item-time text-body-secondary">5
                                                May</small>
                                            <ul class="list-inline email-list-item-actions">
                                                <li
                                                    class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill">
                                ...
                                <li class="email-list-item email-marked-read d-flex align-items-center" data-draft="true"
                                    ...
                                    <div class="d-flex align-items-center w-100">
                                        ...
                                        <span class="ms-sm-2 me-3 d-sm-inline-block d-none"><i
                                                class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                        <img src="{{ asset('assets_2/img/avatars/5.png')}}" alt="user-avatar"
                                            class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32"
                                            width="32" />
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Rachel
                                                Green</span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                                Hey Katy, Chocolate cake pudding chocolate bar ice cream
                                                bonbon lollipop.</small>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                                class="email-list-item-label badge badge-dot bg-warning d-none d-md-inline-block me-2"
                                                data-label="company"></span>
                                            <small class="email-list-item-time text-body-secondary">15
                                                May</small>
                                            <ul class="list-inline email-list-item-actions">
                                                <li
                                                    class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill">
                                ...
                                <li class="email-list-item email-marked-read d-flex align-items-center"
                                    ...
                                    <div class="d-flex align-items-center w-100">
                                        ...
                                        <span class="ms-sm-2 me-3 d-sm-inline-block d-none"><i
                                                class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                        <img src="{{ asset('assets_2/img/avatars/6.png')}}" alt="user-avatar"
                                            class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32"
                                            width="32" />
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Grace
                                                Shelby</span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                                Hey Katy, Icing gummi bears ice cream croissant dessert
                                                wafer.</small>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                            ...
                                            <span
                                                class="email-list-item-label badge badge-dot bg-danger d-none d-md-inline-block me-2"
                                                data-label="private"></span>
                                            <small class="email-list-item-time text-body-secondary">20
                                                Apr</small>
                                            <ul class="list-inline email-list-item-actions">
                                                <li
                                                    class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill">
                                ...
                                <li class="email-list-item email-marked-read d-flex align-items-center" data-spam="true"
                                    ...
                                    <div class="d-flex align-items-center w-100">
                                        ...
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Jacob
                                                Frye</span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                                Hey Katy, Chocolate cake pudding chocolate bar ice cream
                                                Sweet.</small>
                                        ...
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                                class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                                                data-label="important"></span>
                                            <small class="email-list-item-time text-body-secondary">25
                                                Mar</small>
                                            <ul class="list-inline email-list-item-actions">
                                                <li
                                                    class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill">
                                ...
                                <li class="email-list-item email-marked-read d-flex align-items-center" data-trash="true"
                                    ...
                                    <div class="d-flex align-items-center w-100">
                                        ...
                                        <span class="ms-sm-2 me-3 d-sm-inline-block d-none"><i
                                                class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                        <img src="{{ asset('assets_2/img/avatars/9.png')}}" alt="user-avatar"
                                            class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32"
                                            width="32" />
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Alistair
                                                Crowley </span>
                                            <small class="email-list-item-subject d-xl-inline-block d-block">
                                                Hey Katy, I love danish. Cupcake I love carrot cake
                                                sugar plum I love.</small>
                ...
                <div class="col app-email-view flex-grow-0 bg-lightest" id="app-email-view">
                    <div class="card shadow-none border-0 rounded-0 app-email-view-header p-5 pt-md-4 py-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center overflow-hidden">
                                ...
                                <h6 class="text-truncate mb-0 me-2 fw-normal">Focused impactful open
                                    issues</h6>
                    ...
                    <div class="app-email-view-content py-4">
                        <p class="email-earlier-msgs text-center cursor-pointer mb-12">1 Earlier
                            Message</p>
                        ...
                        <div class="card email-card-prev mx-sm-6 mx-3">
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <p class="mb-0 me-4 text-body-secondary">June 20th 2020, 08:30 AM
                                    </p>
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-icon btn-text-secondary rounded-pill p-0" type="button"
                                            id="dropdownEmailOne" data-bs-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">
                                            <i class="icon-base ri ri-more-2-line icon-22px"></i>
                                        </button>
                        ...
                        <div class="card email-card-last mx-sm-6 mx-3 mt-4">
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <p class="mb-0 me-4 text-body-secondary">June 20th 2020, 08:10 AM
                                    </p>
                                    <span class="btn btn-icon btn-text-secondary rounded-pill"><i
                                            class="icon-base ri ri-attachment-2 icon-22px cursor-pointer"></i></span>
                                    <span class="btn btn-icon btn-text-secondary rounded-pill"><i
                        ...
                        <div class="modal-body flex-grow-1 pb-sm-0 px-5 py-2">
                            <form class="email-compose-form">
                                ...
                                <div class="email-compose-actions d-flex justify-content-between align-items-center my-4">
                                    <div class="d-flex align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary dropdown-toggle email-send-btn"
                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                Send <i
                                                    class="icon-base ri ri-send-plane-line icon-sm scaleX-n1-rtl ms-2"></i>
                                            </button>
                                        ...
                                        <label for="attach-file"
                                            class="btn btn-icon btn-text-secondary rounded-pill ms-4"><i
                                    ...
                                    <div class="d-flex align-items-center gap-4">
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-icon btn-text-secondary p-0" type="button"
                                                id="dropdownMoreActions" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
