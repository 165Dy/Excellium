        ...
        <div class="col-md-3">
            <div class="card bg-gradient-warning text-white shadow-sm">
                <div class="card-body text-center py-4">
                    ...
                    <h3 class="fw-bold mb-1">{{ $opportunites->sum(function($o) { return $o->totalCandidatures(); }) }}</h3>
        ...
        <div class="col-md-3">
            <div class="card bg-gradient-info text-white shadow-sm">
                <div class="card-body text-center py-4">
                    ...
                    <h3 class="fw-bold mb-1">{{ $opportunites->where('date_expiration', '>=', now())->count() }}</h3>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <small class="text-muted">
                                        {{ $opportunite->date_expiration->format('d/m/Y') }}
                                        @if($opportunite->isExpired())
                                            <br><span class="text-danger">Expirée</span>
                                        @else
                                            <br><span class="text-success">{{ $opportunite->joursRestants() }} jour(s)</span>
                                        @endif
                                    </small>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <button class="btn btn-warning btn-sm" 
                                                onclick="editerOpportunite({{ $opportunite->id }})"
                                                title="Modifier">
...
<style>
.bg-gradient-primary { background: linear-gradient(135deg, #696ac3, #4f46e5) !important; }
