    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="nav-align-top">
            <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
                ...
                <li class="nav-item" style="background-color: rgb(224, 224, 248); border-radius: 10px 10px;">
                    <a class="nav-link" href="#"><i class="icon-base ri ri-filter-line icon-sm me-2"></i>Tout</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="icon-base ri ri-draft-line icon-sm me-2"></i>Publicités</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="icon-base ri ri-folder-reduce-line icon-sm me-2"></i>Actualités</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="icon-base ri ri-suitcase-fill icon-sm me-2"></i>Conseils</a>
                </li>
            </ul>
        </div>
        <!-- Scrollable -->
        <div class="card">
            <div class="col-md-12">
                ...
                <h2 class="card-header text-center text-md-start pb-md-0">LISTES DE TOUT LES ARTICLES</h2>
