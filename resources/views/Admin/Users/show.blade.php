                    ...
                    <div class="card-body pt-12">
                        <div class="user-avatar-section">
                            <div class="d-flex align-items-center flex-column">
                                <img class="img-fluid rounded mb-4" src="{{ asset('assets_2/img/avatars/1.png') }}"
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled g-2 my-6">
                            <li class="mb-2 d-flex align-items-center">
                                <i class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>10
                                    Users</span>
                            </li>
                            <li class="mb-2 d-flex align-items-center">
                                <i class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>Up
                                    to 10 GB storage</span>
                            </li>
                            <li class="mb-2 d-flex align-items-center">
                                <i class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>Basic
                                    Support</span>
                            </li>
                        </ul>
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
                        <li class="nav-item">
                            <a class="nav-link" href="app-user-view-account.html"><i
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="app-user-view-billing.html"><i
                                    class="icon-base ri ri-bookmark-line icon-sm me-2"></i>Billing &
                                Plans</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card mb-6">
                    <div class="card-header">
                        ...
                        <p class="my-0 card-subtitle">Display content from your connected accounts on
                            your site</p>
                    </div>
                    <div class="card-body pt-0">
                        <div class="d-flex mb-4">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/google.png') }}" alt="google"
                                    class="me-4" height="36" />
                            </div>
                        ...
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/slack.png') }}" alt="slack"
                                    class="me-4" height="36" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                <div class="mb-sm-0 mb-2">
                        ...
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/github.png') }}" alt="github"
                                    class="me-4" height="36" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                <div class="mb-sm-0 mb-2">
                        ...
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/mailchimp.png') }}" alt="mailchimp"
                                    class="me-4" height="36" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                <div class="mb-sm-0 mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/asana.png') }}" alt="asana"
                                    class="me-4" height="36" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                <div class="mb-sm-0 mb-2">
                ...
                <div class="card mb-6">
                    <div class="card-header">
                        ...
                        <p class="my-0 card-subtitle">Display content from social accounts on your
                            site</p>
                    </div>
                    <div class="card-body pt-0">
                        <!-- Social Accounts -->
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/facebook.png') }}" alt="facebook"
                                    class="me-4" height="36" />
                            </div>
                        ...
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/twitter-light.png') }}" alt="twitter"
                                    class="me-4" height="32" data-app-dark-img="icons/brands/twitter-dark.png')}}"
                        ...
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/instagram.png') }}" alt="instagram"
                                    class="me-4" height="36" />
                            </div>
                            <div class="flex-grow-1 row align-items-center me-n1">
                                <div class="col-7 mb-sm-0 mb-2">
                        ...
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/dribbble.png') }}" alt="dribbble"
                                    class="me-4" height="36" />
                            </div>
                            <div class="flex-grow-1 row align-items-center me-n1">
                                <div class="col-7 mb-sm-0 mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets_2/img/icons/brands/behance.png') }}" alt="behance"
                                    class="me-4" height="36" />
                            </div>
                            <div class="flex-grow-1 row align-items-center me-n1">
                                <div class="col-7 mb-sm-0 mb-2">
