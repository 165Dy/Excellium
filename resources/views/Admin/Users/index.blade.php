...
<div class="container-xxl flex-grow-1 container-p-y">
    <!-- Scrollable -->
    <div class="card">
        <center><h2 class="card-header text-center text-md-start pb-md-0">Liste des Utilisateurs</h2></center><br>
