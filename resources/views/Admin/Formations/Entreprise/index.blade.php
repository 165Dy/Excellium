...
@section('index_entreprise')


<div class="container-xxl flex-grow-1 container-p-y">
    <!-- Scrollable -->
    <div class="card">
        <h2 class="card-header text-center text-md-start pb-md-0">Liste des formations en Entreprise</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action" style="justify-content: space-between">
                                <svg style="cursor: pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#4c9edb" d="M9.243 18.997H21v2H3v-4.243l9.9-9.9l4.242 4.243zm5.07-13.557l2.122-2.121a1 1 0 0 1 1.414 0l2.829 2.828a1 1 0 0 1 0 1.415l-2.122 2.121z"/></svg>&nbsp;&nbsp;
